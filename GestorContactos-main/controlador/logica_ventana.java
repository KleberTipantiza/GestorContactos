...
public class logica_ventana implements ActionListener, ListSelectionListener, ItemListener {
	...
	private void cargarContactosRegistrados() {
		 try {
		    	...
		    	JOptionPane.showMessageDialog(delegado, LanguageManager.getString("error_loading"));
		    }
	}
	...
	private void cargarContactosEnTabla() {
	    ...
	    for (persona contacto : contactos) {
	        ...
	        System.out.println("Contacto: " + contacto.getNombre() + ", " + contacto.getTelefono() + ", " + contacto.getEmail());
	    	Object[] fila = { 
	            contacto.getNombre(),
	    ...
	    if (e.getSource() == delegado.btn_add) {
	        ...
	        if ((!nombres.equals("")) && (!telefono.equals("")) && (!email.equals(""))) {
	            ...
	            if ((!categoria.equals("Elija una Categoria")) && (!categoria.equals(""))) {
	                ...
	                JOptionPane.showMessageDialog(delegado, LanguageManager.getString("contact_added"));
	            } else {
	            	...
	            	JOptionPane.showMessageDialog(delegado, LanguageManager.getString("fill_fields"));
	            }
	        } else {
	...
	private void exportarContactosCSV() {
	    ...
	    SwingWorker<Void, Integer> worker = new SwingWorker<>() {
	        ...
	        @Override
	        protected void done() {
	        	JOptionPane.showMessageDialog(delegado, LanguageManager.getString("export_success"));
